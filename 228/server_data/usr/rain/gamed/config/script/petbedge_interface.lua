...
function ZLuaAvailablePets()
	...
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=0,default_potential=10,born_special=15}	---//才人1(特殊)(特定)	
	
	AvailablePets["cairen_2"]=
	{pet_tid=28558,race=Race["teshu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=0,default_potential=10,born_special=15}	---//才人2(特殊)(特定)	
	
	AvailablePets["cairen_3"]=
	{pet_tid=28559,race=Race["teshu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=0,default_potential=10,born_special=15}	---//才人3(特殊)(特定)	
	
	AvailablePets["cairen_4"]=
	{pet_tid=28560,race=Race["teshu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=0,default_potential=10,born_special=15}	---//才人4(特殊)(特定)	
	
	AvailablePets["cairen_5"]=
	{pet_tid=28561,race=Race["teshu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=0,default_potential=10,born_special=15}	---//才人5(特殊)(特定)
