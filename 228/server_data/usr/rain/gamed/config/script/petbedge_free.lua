...
local ItemChanceFromStar={}
	...
	if pet_tid==AvailablePets["S_kuilei01"].pet_tid or  pet_tid==AvailablePets["S_kuilei02"].pet_tid 
			...
			or  pet_tid==AvailablePets["S_kuilei07"].pet_tid  or  pet_tid==AvailablePets["cairen_1"].pet_tid  
		  or  pet_tid==AvailablePets["cairen_2"].pet_tid    or  pet_tid==AvailablePets["cairen_3"].pet_tid
		  or  pet_tid==AvailablePets["cairen_4"].pet_tid    or  pet_tid==AvailablePets["cairen_5"].pet_tid then
...
function ZLuaPetBedgeElementInfo(pet_tid,origin)
  if ZLuaPetBedgeExistInTmplIDs(pet_tid) == 0 then 
	...
	elseif pet_tid==AvailablePets["maozei"].pet_tid then 
		...
		elementchance={100,100,100,100,100,100}
	elseif pet_tid==AvailablePets["dahuilang"].pet_tid then 
	...
	elseif pet_tid==AvailablePets["zhanshenxingxing"].pet_tid then 
		...
		elementchance={100,100,100,100,100,100}
	elseif pet_tid==AvailablePets["huli"].pet_tid then 
	...
	elseif pet_tid==AvailablePets["yanmo"].pet_tid then 
		...
		elementchance={100,100,100,100,100,100}
	elseif pet_tid==AvailablePets["zx2libaochong"].pet_tid or pet_tid==AvailablePets["qingtianzhanhun"].pet_tid then 
...
function PetBedgeTalk(pet_tid,pet)
  ...
  if ZLuaPetBedgeExistInTmplIDs(pet_tid) == 0 then 
	...
	elseif pet_tid==AvailablePets["dahuilang"].pet_tid then ---//待修改
		talk[2]={}
		talk[3]={}
		talk[4]={}
		talk[5]={}
	elseif pet_tid==AvailablePets["xiaomianyang"].pet_tid then ---//待修改
		talk[2]={}
		talk[3]={}
		talk[4]={}
		talk[5]={}	
	elseif pet_tid==AvailablePets["huli"].pet_tid then ---//待修改
		talk[2]={}
		talk[3]={}
		talk[4]={}
		talk[5]={}
	...
	elseif pet_tid==AvailablePets["zx2libaochong"].pet_tid or pet_tid==AvailablePets["qingtianzhanhun"].pet_tid then ---//待修改
		talk[2]={}
		talk[3]={}
		talk[4]={}
		talk[5]={}
	...
	elseif petelement==Element["kuangye"] then---//狂野
		talk[1]={5121,5122,5123,5125,5125,5125,5127,5128,5129,5130}
	...
	elseif petelement==Element["shensheng"] then---//神圣
		talk[1]={5221,5222,5223,5225,5225,5225,5227,5228,5229,5230}
	elseif petelement==Element["ruizhi"] then---//睿智
		talk[1]={5231,5232,5233,5234,5235,5236,5237,5238,5239,5250}
	elseif petelement==Element["miantian"] then---//腼腆
		talk[1]={5251,5252,5253,5254,5255,5256,5257,5258,5259,5250}
	elseif petelement==Element["boxue"] then---//博学
		talk[1]={5251,5252,5253,5254,5255,5256,5257,5258,5259,5250}
	elseif petelement==Element["gupi"] then---//孤僻	
		talk[1]={5251,5252,5253,5254,5255,5256,5257,5258,5259,5270}
