...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType6576SelectNumber(list, max_count) --- Lottery Used@20070618(台湾_神木宝盒)
	local NumList={1,2,3,4}
	local NumChance={360,360,360,180}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
function LotteryType19240SelectNumber(list, max_count) --- Lottery Used@20080729(台湾_神龙秘籍)
	local NumList={1,2,3}
	local NumChance={127,272,601}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType7916SelectNumber(list, max_count) --- Lottery Used@20070706(台湾_玄龟金鼎)
	local NumList={1,2,3}
...
-------------------------------------------------------------------------------------------------------------
function LotteryType10722SelectNumber(list, max_count) --- Lottery Used@200708XX(台湾_灵狐元丹)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType12006SelectNumber(list, max_count) --- Lottery Used@2008928(台湾_龙驹宝鉴)
	local NumList={1,2,3,4}
	local NumChance={95,130,300,475}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType13318SelectNumber(list, max_count) --- Lottery Used@20071123(台湾_绽魂仙羽)
	local NumList={1,2,3,4}
	local NumChance={50,100,100,750}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType13319SelectNumber(list, max_count) --- Lottery Used@20071123(台湾_乾坤遁宝)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType13905SelectNumber(list, max_count) --- Lottery Used@20090723(狼图腾)
	local NumList={1,2,3,4}
	local NumChance={1443,4000,2643,1914}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType15677SelectNumber(list, max_count) --- Lottery Used@20090206(台湾_狮王之心)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType18283SelectNumber(list, max_count) --- Lottery Used@20090605(台湾_麒麟金尊)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType18799SelectNumber(list, max_count) --- Lottery Used@20080601(台湾_昆仑天晶)
	local NumList={1,2,3,4}
	local NumChance={2000,2160,3000,2840}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType20284SelectNumber(list, max_count) 			--- Lottery Used@20090305(台湾_苍穹光印)
	local NumList={1,2,3,4}
	local NumChance={1494,2160,3000,3346}
	return NumList[ZLottery_Get_RanPoint(NumChance)]
end
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType19558SelectNumber(list, max_count) 			--- Lottery Used@20090112(如意之鼓)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType19297SelectNumber(list, max_count) 			--- Lottery Used@20090303(台湾_云光天鉴)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType20109SelectNumber(list, max_count) 			--- Lottery Used@20090513(台湾_鸣珏瑰玉)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType23144SelectNumber(list, max_count)			--- Lottery Used@20090618(台湾_轮盘:天鹅)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType21752SelectNumber(list, max_count)			--- Lottery Used@20090724(台湾_天眷神篇/雪琪月虚拟币彩票)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType23295SelectNumber(list, max_count) --- Lottery Used@20090724(台湾_宠物彩票：鸿蒙秘宝)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType21697SelectNumber(list, max_count)			--- Lottery Used@20090903(台湾_极东绽石)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType19713SelectNumber(list, max_count) 			--- Lottery Used@20090923(台湾_炎蹄之心)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType20482SelectNumber(list, max_count)			--- Lottery Used@20091105(台湾_龙皇古卷)
	local NumList={1,2,3,4}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType23212SelectNumber(list, max_count)			--- Lottery Used@20090211(台湾轮盘:圣龙玉髓)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType28573SelectNumber(list, max_count)			--- Lottery Used@20091105(台湾_混沌秘宝)
...
function LotteryType6576Cashing(cur_list)		---(台湾_神木宝盒)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType19240Cashing(cur_list)	---(台湾_神龙秘籍)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
	...
	Out_Prize[1][19241]=100
	
	Out_Prize[2][7540]=100
	Out_Prize[2][7541]=100     
	
	Out_Prize[3][6473]=100    ---月华
...
-------------------------------------------------------------------------------------------------------------
function LotteryType7916Cashing(cur_list)	---(台湾_玄龟金鼎)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
	...
	Out_Prize[1][17853]=100    ---6.1龙龟
	
	Out_Prize[2][4712]=100     ---山河扇
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType10722Cashing(cur_list)	---(台湾_灵狐元丹)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
--------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType12006Cashing(cur_list)	---(台湾_龙驹宝鉴)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
	...
	ZLottery_FindSameNum(cur_list,1)==2 or ZLottery_FindSameNum(cur_list,2)==2 then 
		...
		prizeout=lot_prize[4][ZLottery_Get_RanPoint(lot_prizechance[4])]
		return 4,0,prizeout,4,0,0
	end
	return 4,0,8079,4,0,0 
end 
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType13318Cashing(cur_list)	---(台湾_绽魂仙羽)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
	...
	Out_Prize[2][13344]=100		---//箱子兑换券		

	Out_Prize[3][11678]=20		---玄真秘文石
	Out_Prize[3][11676]=20		---魔魂秘文石
	Out_Prize[3][11679]=20		---佛尊秘文石			
	Out_Prize[3][11677]=20		---奇艳秘文石
	Out_Prize[3][17832]=20    ---魔骨秘文石
...
function LotteryType13377Cashing(cur_list)	---(虚拟币出产箱子的绽魂仙羽)
	...
	Out_Prize[3][11678]=25		---玄真秘文石
	Out_Prize[3][11676]=25		---魔魂秘文石
	Out_Prize[3][11679]=25		---佛尊秘文石			
	Out_Prize[3][11677]=25		---奇艳秘文石
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType13319Cashing(cur_list)	---(台湾_乾坤遁宝)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType13905Cashing(cur_list)		---(台湾_狼图腾)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
	...
	Out_Prize[3][13901]=100	---//加Def药
	Out_Prize[3][13900]=100	---//加Atk药
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType15677Cashing(cur_list)		---(台湾_狮王之心090206)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
	...
	Out_Prize[2][7931]=40     ---结婚大礼包男
	Out_Prize[2][7937]=60	    ---结婚大礼包女

	Out_Prize[3][18794]=100	  ---仙豆
	
	
	Out_Prize[4][8079]=100    ---飞天
...
-------------------------------------------------------------------------------------------------------------
function LotteryType15866Cashing(cur_list)		---(20090407——台湾_雷光墨玉)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType18283Cashing(cur_list)		---(台湾_麒麟金尊)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-----------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType19297Cashing(cur_list)		---(台湾_云光天鉴090303)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType18799Cashing(cur_list)		---(台湾_昆仑天晶)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType20284Cashing(cur_list)		---(台湾_苍穹光印090505)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType23212Cashing(cur_list)		---(台湾轮盘:圣龙玉髓)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType23295Cashing(cur_list)		---(台湾_宠物彩票：鸿蒙秘宝)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType18890Cashing(cur_list)		---(台湾_行天圣宝)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
	...
	Out_Prize[1][18904]=100		---飞剑龙骧
	
	Out_Prize[2][13307]=70	---鬼面面具
	Out_Prize[2][13306]=30	---蝴蝶面饰	
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType20109Cashing(cur_list)		---(台湾_鸣珏瑰玉)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType21697Cashing(cur_list)		---(台湾_极东绽石)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType19713Cashing(cur_list)		---(台湾_炎蹄之心)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType28573Cashing(cur_list)		---(台湾_混沌秘宝)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryType20482Cashing(cur_list)		---(台湾_龙皇古卷)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-------------------------------------------------------------------------------------------------------------
-------------------------------------------------------------------------------------------------------------
function LotteryTypeGoldSeason2Cashing(cur_list,id)		---(台湾版_虚拟币回收彩票/宠物技能书)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
function LotteryTypeItemSeason1Cashing(cur_list,id)		---(金币回收彩票)
	...
	if id==19112 then
		...
		Out_Prize[1][14621]={chance=100,num=1}---//氓山神刺
		Out_Prize[1][14628]={chance=100,num=1}---//鸣歧骨刺
		...
		Out_Prize[1][2980]={chance=100,num=1}---//鬼冢狂刀
		Out_Prize[1][2987]={chance=100,num=1}---//天弃仙环
		Out_Prize[1][2994]={chance=100,num=1}---//道谕法剑
		Out_Prize[1][3001]={chance=100,num=1}---//佛偈法杖
		...
		Out_Prize[1][5271]={chance=100,num=1}---//七杀魔刀
		Out_Prize[1][5277]={chance=100,num=1}---//梏情灵环
		Out_Prize[1][5283]={chance=100,num=1}---//中平古剑
		Out_Prize[1][5289]={chance=100,num=1}---//顿喝古杖
	...
	elseif id==19113 then 
		...
		Out_Prize[1][14622]={chance=100,num=1}---//浴火金戈刺
		Out_Prize[1][14629]={chance=100,num=1}---//幽冥化血刺
		...
		Out_Prize[1][2981]={chance=100,num=1}---//天邪屠龙刃
		Out_Prize[1][2988]={chance=100,num=1}---//迷离苦情轮
		Out_Prize[1][2995]={chance=100,num=1}---//天启龙纹剑
		Out_Prize[1][3002]={chance=100,num=1}---//雷音破邪杖
		...
		Out_Prize[1][8717]={chance=100,num=1}---//狂魔戮魂刀
		Out_Prize[1][8741]={chance=100,num=1}---//泣血缚心环
		Out_Prize[1][8765]={chance=100,num=1}---//镇岳尚方剑
		Out_Prize[1][8789]={chance=100,num=1}---//大德梵心杖
	...
	elseif id==19114 then
		...
		Out_Prize[1][14623]={chance=100,num=1}---//七步燃魂刺
		Out_Prize[1][14630]={chance=100,num=1}---//五鬼开山刺
		...
		Out_Prize[1][2982]={chance=100,num=1}---//七星斩将刀
		Out_Prize[1][2989]={chance=100,num=1}---//七彩烨空环
		Out_Prize[1][2996]={chance=100,num=1}---//七绝破山剑
		Out_Prize[1][3003]={chance=100,num=1}---//七宝封怨杖
		...
		Out_Prize[1][8723]={chance=100,num=1}---//五鬼啖魂刃
		Out_Prize[1][8747]={chance=100,num=1}---//五味迷情轮
		Out_Prize[1][8771]={chance=100,num=1}---//五雷摄天剑
		Out_Prize[1][8795]={chance=100,num=1}---//五福渡心杖
	...
	elseif id==19115 then 
		...
		Out_Prize[1][14624]={chance=100,num=1}---//回转阴阳乾坤刺
		Out_Prize[1][14631]={chance=100,num=1}---//噬心化骨鬼牙刺
		...
		Out_Prize[1][2983]={chance=100,num=1}---//傲世龙襄赤冶刃
		Out_Prize[1][2990]={chance=100,num=1}---//纵情妄念惑心环
		Out_Prize[1][2997]={chance=100,num=1}---//旷天铸道赤宵剑
		Out_Prize[1][3004]={chance=100,num=1}---//韦陀降魔金光杵
		...
		Out_Prize[1][8729]={chance=100,num=1}---//霸天华闪流光刃
		Out_Prize[1][8753]={chance=100,num=1}---//狂情天麓幻光轮
		Out_Prize[1][8777]={chance=100,num=1}---//梁神启元龙光剑
		Out_Prize[1][8801]={chance=100,num=1}---//众生渡劫圣至杖
...
function LotteryType23144Cashing(cur_list)		---(台湾_轮盘:天鹅)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
-----------------------------------------------------------------------------------------
function LotteryTypeGoldSeason1Cashing(cur_list,id)	---(第一批护符材料)
	---fmax_count为该彩票的有效位数
	local cp
	local nowcurlist={}
	local fmax_count=table.getn(cur_list)
...
function LotterySelectNumber(id, max_count,cur_list)
	...
	elseif(id==19240) then
		return LotteryType19240SelectNumber(cur_list,max_count);
	elseif(id==7916) then
...
function LotteryCashing(id,cur_list)
	...
	elseif(id == 19240) then
		return LotteryType19240Cashing(cur_list);
	elseif(id == 7916) then
